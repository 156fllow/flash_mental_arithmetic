    ...
    return Scaffold(
      ...
      body: Column(
        ...
        TextButton(
          ...
          onPressed: (){
            Navigator.push(context,MaterialPageRoute(builder: (context) => SelectDiffMenu(title:widget.title)));
          },
...
class SelectDiffMenu extends StatefulWidget{
  SelectDiffMenu({Key key,this.title}) : super(key: key);
      ...
      body: GridView.builder(
        ...
        itemBuilder: (BuildContext context,int index) {
          return GestureDetector(
            ...
            onTap: () {
              print(data[index]);
              Navigator.push(context,MaterialPageRoute(builder: (context) => TestModePageState(title: widget.title,settings:data[index])));
            },
          );
        },
...
class TestModePageState extends StatefulWidget{
  TestModePageState({Key key,this.title,this.settings}) : super(key: key);
...
class _TestModePageState extends State<TestModePageState> {
  ...
  Widget build(BuildContext context) {
    ...
    Future<void> Exam_Start(double showTime,int showCount,int digits) async {
      ...
      // SharedPreferences prefs = await SharedPreferences.getInstance();
      int test_grade = (widget.settings[0]).toInt();
      int test_digits = (widget.settings[1]).toInt();
      int test_count = (widget.settings[2]).toInt();
      double test_totaltime = (widget.settings[3]).toDouble();

      double showTime;
      int showCount;
      int digits;

      showTime = (test_totaltime / test_count);
      showCount = test_count;
      digits = test_digits;
      print(showTime);
